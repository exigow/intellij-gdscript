...
public class GDScriptParser extends Parser {
	...
	public final FileContext file() throws RecognitionException {
		...
		try {
			...
			do {
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
			} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__6) | (1L << EXPORT) | (1L << ONREADY) | (1L << VAR) | (1L << STATIC) | (1L << FUNC) | (1L << CLASS) | (1L << EXTENDS) | (1L << CLASS_NAME) | (1L << ENUM) | (1L << IF) | (1L << ELIF) | (1L << ELSE) | (1L << RETURN) | (1L << IDENTIFIER) | (1L << NUMBER) | (1L << STRING) | (1L << LINE_COMMENT) | (1L << BLOCK_COMMENT) | (1L << NL))) != 0) );
			setState(37);
			match(EOF);
			}
		}
	...
	public static final String _serializedATN =
		...
		"\20\u00b8\13\20\3\20\3\20\3\20\2\2\21\2\4\6\b\n\f\16\20\22\24\26\30\32"+
		"\34\36\2\3\4\2\31\31\33\33\2\u00d4\2#\3\2\2\2\4\65\3\2\2\2\6F\3\2\2\2"+
		"\b`\3\2\2\2\nv\3\2\2\2\fz\3\2\2\2\16}\3\2\2\2\20\u0083\3\2\2\2\22\u0089"+
		"\3\2\2\2\24\u008d\3\2\2\2\26\u0091\3\2\2\2\30\u0094\3\2\2\2\32\u009e\3"+
		"\2\2\2\34\u00a0\3\2\2\2\36\u00ae\3\2\2\2 $\5\4\3\2!$\5\32\16\2\"$\7\36"+
