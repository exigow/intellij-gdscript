...
class ScriptHighlighter : SyntaxHighlighterBase() {
    ...
    private fun matchingToColor(element: IElementType?) = when (element) {
        ...
        in ScriptTokenSet.CONSTANTS -> ColorTextAttributeKey.CONSTANT
        ...
        in ScriptTokenSet.COLONS -> ColorTextAttributeKey.COLON
        in ScriptTokenSet.ARROWS -> ColorTextAttributeKey.ARROW
