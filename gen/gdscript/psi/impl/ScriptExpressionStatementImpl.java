...
public class ScriptExpressionStatementImpl extends ScriptBaseElement implements ScriptExpressionStatement {

  public ScriptExpressionStatementImpl(@NotNull ASTNode node) {
    super(node);
  }
