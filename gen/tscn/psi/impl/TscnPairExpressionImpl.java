...
public class TscnPairExpressionImpl extends TscnBaseElement implements TscnPairExpression {

  public TscnPairExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull TscnVisitor visitor) {
    visitor.visitPairExpression(this);
  }
